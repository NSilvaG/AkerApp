                    ...
                    user.updateEmail(newEmail.getText().toString().trim()).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                Toast.makeText(MainActivity.this, "El correo electrónico ha sido actualizado. Por favor inicie sesión con el nuevo correo electrónico", Toast.LENGTH_SHORT).show();
                                signOut();
                                progressBar.setVisibility(View.GONE);
                            }else{
                                Toast.makeText(MainActivity.this, "No se pudo actualizar el correo electrónico", Toast.LENGTH_SHORT).show();
                                progressBar.setVisibility(View.GONE);
                            }
                        }
                    });
                }else if(newEmail.getText().toString().trim().equals("")){
                    newEmail.setError("Ingrese su correo electrónico");
                    progressBar.setVisibility(View.GONE);
                }
            }
        });
                ...
                if (user != null && !newPassword.getText().toString().trim().equals("")){
                    if (newPassword.getText().toString().trim().length() < 6){
                        ...
                        user.updatePassword(newPassword.getText().toString().trim()).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()){
                                    Toast.makeText(MainActivity.this, "La contraseña ha sido actualizada. Por favor inicie sesión con la nueva contraseña", Toast.LENGTH_SHORT).show();
                                    signOut();
                                    progressBar.setVisibility(View.GONE);
                                }else {
                    ...
                    newPassword.setError("Ingrese su contraseña");
                    progressBar.setVisibility(View.GONE);
                }
            }
        });
             ...
             public void onClick(View v) {
                 ...
                 if (!oldEmail.getText().toString().trim().equals("")){
                     auth.sendPasswordResetEmail(oldEmail.getText().toString().trim()).addOnCompleteListener(new OnCompleteListener<Void>() {
                         ...
                         public void onComplete(@NonNull Task<Void> task) {
                             if (task.isSuccessful()){
                                 Toast.makeText(MainActivity.this, "Se envío un correo electrónico para restablecimiento de su contraseña", Toast.LENGTH_SHORT).show();
                                 progressBar.setVisibility(View.GONE);
                             }else{
                     ...
                     oldEmail.setError("Ingrese su correo electrónico");
                     progressBar.setVisibility(View.GONE);
                 }
             }
         });
